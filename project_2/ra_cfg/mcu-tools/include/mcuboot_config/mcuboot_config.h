...
#define RM_MCUBOOT_PORT_CFG_MCUBOOT_SIZE           (0x00010000)
#if (MCUBOOT_IMAGE_NUMBER == 1)
 #define RM_MCUBOOT_PORT_CFG_PARTITION_SIZE        (0x00078000)
#else
 #define RM_MCUBOOT_PORT_CFG_S_PARTITION_SIZE      (0x00078000)
#endif
